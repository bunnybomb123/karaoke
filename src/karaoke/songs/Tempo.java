...
/**
 * A Tempo is a tempo marking, specifying a note length as a fraction and the number of such notes a minute.
 */
public class Tempo {
     ...
     *      in a minute, and with string representation symbol.
     * 
     * Rep invariant
